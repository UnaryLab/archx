...
def query(input_path, output_path):
    ...
    end_to_end_breakdown.to_csv(output_path + 'op_carbon_hardware.csv', index=False)
    ...
    end_to_end_breakdown.to_csv(output_path + 'op_carbon_hardware_norm.csv', index=False)

def figure(input_path: str, output_path: str):

    df = pd.read_csv(input_path + 'op_carbon_hardware_norm.csv')
    ...
    plt.savefig(output_path + 'op_carbon_hardware.png', dpi=1200, bbox_inches='tight')
    plt.savefig(output_path + 'op_carbon_hardware.pdf', dpi=1200, bbox_inches='tight')