from zoo.llm.results.query import area_power_breakdown, area_power_breakdown_scaled, attention_size_breakdown, batch_size_breakdown, comprehensive_table, dram_roofline, end_to_end_latency_breakdown, \
    gemm_breakdown, noc_breakdown, nonlinear_breakdown, op_carbon, op_carbon_hardware, embodied_carbon, carbon
...
# # carbon.query(input_path=input_path, output_path=csv_path)
...
# #carbon.figure(input_path=csv_path, output_path=fig_path)
