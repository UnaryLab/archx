...
def description(path):
    ...
    event.add_event(name='gemm', subevent=['pipeline', 'add', 'addi', 'andi', 'beq', 'blt', 'jal',
                                           ...
                                           performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='pipeline', subevent=['instr_fetch', 'decode', 'execute', 'mem', 'wb', 'hd', 'forward'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='add', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='addi_0', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='addi', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='andi', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='beq', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='blt', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='jal', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='jalr', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='lui', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='lw', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='slli', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='srli', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
    event.add_event(name='sw', subevent=['compute'], performance='zoo/agraph/designs/riscv/performance.py')
