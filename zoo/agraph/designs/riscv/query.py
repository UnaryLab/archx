...
base_path = 'zoo/agraph/designs/riscv/'
...
for config in configs:
    ...
    cycle_count_value = cycle_count['value']
    pipelined_runtime = (runtime_value / cycle_count_value) * (cycle_count_value - 5)

    syn_energy = dynamic_power_dict['1'] * pipelined_runtime * 1e3#
