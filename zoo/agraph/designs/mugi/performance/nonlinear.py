...
def weight_nonlinear(architecture_dict: OrderedDict, workload_dict: OrderedDict=None)->OrderedDict:
    ...
    min_max_tree_dim = architecture_dict['min_max_tree']['instance'][-1]
    min_max_tree_register_dim = architecture_dict['min_max_tree_register']['instance'][-1]
    ...
    min_max_tree_dict = OrderedDict({'count': min_max_tree_dim})
    min_max_tree_register_dict = OrderedDict({'count': min_max_tree_register_dim})
    ...
    performance_dict['subevent'] = OrderedDict({'round': round_dict,
                                                ...
                                                'wfifo': wfifo_dict,
                                                'min_max_tree': min_max_tree_dict,
                                                'min_max_tree_register': min_max_tree_register_dict,
