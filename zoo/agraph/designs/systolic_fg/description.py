...
def description(path):
    ...
    ###############    Event    ##################
    ##############################################
    event.add_event(name='gemm', subevent=['input_reads', 'weight_reads', 'output_writes', 'input_array', 'weight_array'], performance='zoo/agraph/designs/systolic_fg/performance.py')
    event.add_event(name='input_reads', subevent=['isram'], performance='zoo/agraph/designs/systolic_fg/performance.py')
    event.add_event(name='weight_reads', subevent=['wsram'], performance='zoo/agraph/designs/systolic_fg/performance.py')
    event.add_event(name='output_writes', subevent=['osram'], performance='zoo/agraph/designs/systolic_fg/performance.py')
    event.add_event(name='input_array', subevent=['ififo', 'wfifo', 'ofifo', 'output_adder', 'multiplier', 'adder', 'act_en_reg', 'mult_en_reg', 'acc_en_reg', 'sum_en_reg', 'act_reg', 'sum_reg',
                                                'act_mux', 'weight_mux', 'add_mux', 'sum_mux'], performance='zoo/agraph/designs/systolic_fg/performance.py')
    event.add_event(name='weight_array', subevent=['weight_path_en_reg', 'weight_en_reg', 'weight_path_reg', 'weight_reg'], performance='zoo/agraph/designs/systolic_fg/performance.py')
