```csv_cmos_asplos_2026_ae``` interface for Archx, characterized on NanGate45.

## Usage
```csv_cmos_asplos_2026_ae_extract.py``` generates .csv files from synthesis and place-and-route reports.

All inputs and outputs are under the ```csv_cmos_asplos_2026_ae``` directory.
