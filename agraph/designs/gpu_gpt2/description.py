...
def description(path):
    ...
    event.add_event(name='gpt2', subevent=['addmm', 'softmax', 'add', 'tanh', 'bmm', 'where', 'mul', 'div', 'gather', 'cat', 'copy',
                                           ...
                                           performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='addmm', subevent=['k0008', 'k0010', 'k0011', 'k0020'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='softmax', subevent=['k0004'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='add', subevent=['k0001', 'k0014', 'k0017', 'k0016', 'k0058', 'k0059'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='tanh', subevent=['k0015'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='bmm', subevent=['k0009', 'k0007'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='where', subevent=['k0002', 'k0022'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='mul', subevent=['k0005', 'k0013', 'k0033', 'k0048'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='div', subevent=['k0003'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='gather', subevent=['k0026', 'k0025'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='cat', subevent=['k0006', 'k0035'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='copy', subevent=['k0019', 'k0018', 'k0029', 'k0036', 'k0037', 'k0052'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='native_layer_norm', subevent=['k0012'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='bitwise_and', subevent=['k0021', 'k0034', 'k0049'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='mm', subevent=['k0023'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='le', subevent=['k0031'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='argmax', subevent=['k0027'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='masked_fill', subevent=['k0055'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='sub', subevent=['k0053', 'k0042', 'k0056'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='gt', subevent=['k0024'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='cumsum', subevent=['k0028', 'k0040', 'k0062'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='index', subevent=['k0030'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='any', subevent=['k0032'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='fill', subevent=['k0038', 'k0043', 'k0046', 'k0061'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='sum', subevent=['k0041'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='eq', subevent=['k0044', 'k0050', 'k0051', 'k0054'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='arange', subevent=['k0045', 'k0047'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='bitwise_not', subevent=['k0057'], performance='agraph/designs/gpu_gpt2/performance.py')
    event.add_event(name='ge', subevent=['k0060'], performance='agraph/designs/gpu_gpt2/performance.py')
    ##############################################
    ###############    Metric    #################
    ##############################################
