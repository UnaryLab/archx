...
def description(path):
    ...
    ###############    Event    ##################
    ##############################################
    event.add_event(name='llama_2_7b', subevent=['gemm', 'nonlinear'], performance='agraph/designs/mugi/performance/llama.py')
    event.add_event(name='gemm', subevent=['projection', 'attention', 'ffn', 'output'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='nonlinear', subevent=['softmax', 'silu'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='projection', subevent=['proj_q', 'proj_k', 'proj_v', 'proj_a'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='attention', subevent=['qkt', 'av'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='ffn', subevent=['proj_up', 'proj_down', 'proj_gate'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='output', subevent=['output_prefill', 'output_decode'], performance='agraph/designs/mugi/performance/model_arch.py')

    event.add_event(name='proj_q', subevent=['proj_q_prefill', 'proj_q_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_k', subevent=['proj_k_prefill', 'proj_k_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_v', subevent=['proj_v_prefill', 'proj_v_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_a', subevent=['proj_a_prefill', 'proj_a_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='qkt', subevent=['qkt_prefill', 'qkt_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='av', subevent=['av_prefill', 'av_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_up', subevent=['proj_up_prefill', 'proj_up_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_down', subevent=['proj_down_prefill', 'proj_down_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='proj_gate', subevent=['proj_gate_prefill', 'proj_gate_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='softmax', subevent=['softmax_prefill', 'softmax_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    event.add_event(name='silu', subevent=['silu_prefill', 'silu_decode'], performance='agraph/designs/mugi/performance/model_arch.py')
    ...
    event.add_event(name='proj_q_prefill', subevent=['isram_offchip_writes', 'wsram_offchip_writes', 'osram_offchip_writes', 'osram_offchip_reads', 'isram_onchip_reads', 'wsram_onchip_reads',
                                           ...
                                           'weight_reuse_gemm', 'array_gemm', 'array_fifo_gemm', 'nonlinear_gemm'], performance='agraph/designs/mugi/performance/model_arch.py')
    ...
    event.add_event(name='softmax_prefill', subevent=['isram_offchip_writes', 'wsram_offchip_writes', 'osram_offchip_writes', 'osram_offchip_reads', 'isram_onchip_reads', 'wsram_onchip_reads',
                                                ...
                                                'weight_reuse_nonlinear', 'array_nonlinear', 'array_fifo_nonlinear', 'summation', 'gemm_nonlinear'], performance='agraph/designs/mugi/performance/model_arch.py')
    ...
    event.add_event(name='instruction', subevent=['imux', 'wmux'], performance='agraph/designs/mugi/performance/common.py')
    event.add_event(name='counter_reuse', subevent=['counter', 'counter_register'], performance='agraph/designs/mugi/performance/common.py')
    event.add_event(name='vector', subevent=['multiplier_vector', 'register_vector'], performance='agraph/designs/mugi/performance/common.py')

    event.add_event(name='input_gemm', subevent=['ififo'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='input_reuse_gemm', subevent=['multiplier', 'multiplier_register'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='weight_gemm', subevent=['wfifo', 'magnitude_register', 'sign_register', 'sign_fifo'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='weight_reuse_gemm', subevent=['comparator'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='array_gemm', subevent=['temporal_register', 'and_gate', 'or_gate', 'sign_xor', 'adder', 'ofifo'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='array_fifo_gemm', subevent=['or_gate', 'pe_fifo'], performance='agraph/designs/mugi/performance/gemm.py')
    event.add_event(name='nonlinear_gemm', subevent=['round', 'sign_mantissa_register', 'exponent_register', 'exp_clamp', 'window_select', 'exp_norm', 'exp_select', 'min_max_tree', 'min_max_tree_register'], performance='agraph/designs/mugi/performance/gemm.py')
    
    event.add_event(name='input_nonlinear', subevent=['ififo'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='weight_nonlinear', subevent=['round', 'sign_mantissa_register', 'exponent_register', 'exp_clamp', 'window_select', 'wfifo',
               'min_max_tree', 'min_max_tree_register', 'magnitude_register', 'sign_register', 'exp_norm', 'exp_select', 'ofifo'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='weight_reuse_nonlinear', subevent=['comparator'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='array_nonlinear', subevent=['temporal_register', 'and_gate', 'or_gate'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='array_fifo_nonlinear', subevent=['or_gate', 'pe_fifo'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='summation', subevent=['adder'], performance='agraph/designs/mugi/performance/nonlinear.py')
    event.add_event(name='gemm_nonlinear', subevent=['multiplier', 'multiplier_register', 'sign_xor', 'sign_fifo'], performance='agraph/designs/mugi/performance/nonlinear.py')

    event.add_event(name='isram_offchip_writes', subevent=['isram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='wsram_offchip_writes', subevent=['wsram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='osram_offchip_writes', subevent=['osram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='osram_offchip_reads', subevent=['osram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='isram_onchip_reads', subevent=['isram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='wsram_onchip_reads', subevent=['wsram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='osram_onchip_reads', subevent=['osram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='osram_onchip_writes', subevent=['osram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='dram_input_reads', subevent=['dram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='dram_weight_reads', subevent=['dram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='dram_output_writes', subevent=['dram'], performance='agraph/designs/mugi/performance/memory.py')
    event.add_event(name='dram_output_reads', subevent=['dram'], performance='agraph/designs/mugi/performance/memory.py')

    # event.add_event(name='irouter_mapping', subevent=['irouter'], performance='agraph/designs/mugi/performance/router.py')
    # event.add_event(name='wrouter_mapping', subevent=['wrouter'], performance='agraph/designs/mugi/performance/router.py')
    # event.add_event(name='orouter_mapping', subevent=['orouter'], performance='agraph/designs/mugi/performance/router.py')
