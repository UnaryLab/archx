...
def description(path):
    ...
    ###############    Event    ##################
    ##############################################
    event.add_event(name='gemm', subevent=['input_reads', 'weight_reads', 'output_writes', 'input_array'], performance='agraph/designs/systolic_cg/performance.py')
    event.add_event(name='input_reads', subevent=['isram'], performance='agraph/designs/systolic_cg/performance.py')
    event.add_event(name='weight_reads', subevent=['wsram'], performance='agraph/designs/systolic_cg/performance.py')
    event.add_event(name='output_writes', subevent=['osram'], performance='agraph/designs/systolic_cg/performance.py')
    event.add_event(name='input_array', subevent=['ififo', 'wfifo', 'ofifo', 'output_adder', 'pe'], performance='agraph/designs/systolic_cg/performance.py')
