...
def description(path):
    ...
    event.add_event(name='fir', subevent=['fir_mult', 'fir_adder', 'fir_control'], performance='agraph/designs/sc_fir/performance.py')
    event.add_event(name='fir_mult', subevent=['mult'], performance='agraph/designs/sc_fir/performance.py')
    event.add_event(name='fir_adder', subevent=['acc'], performance='agraph/designs/sc_fir/performance.py')
    event.add_event(name='fir_control', subevent=['shift_reg', 'pnm', 'control'], performance='agraph/designs/sc_fir/performance.py')
