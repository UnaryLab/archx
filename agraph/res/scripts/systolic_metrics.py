...
systolic_fg_path = 'agraph/designs/systolic_fg/results/'
systolic_cg_path = 'agraph/designs/systolic_cg/results/'
...
pdf_path = 'agraph/res/figures/systolic_validation.pdf'
# Save the figure
