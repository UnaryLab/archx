...
fir_path = 'agraph/designs/sc_fir/results/'

# Read combined area.csv (and throughput.csv if available)
area_csv_path = 'agraph/designs/sc_fir/results/area.csv'
throughput_csv_path = 'agraph/designs/sc_fir/results/throughput.csv'  # Update if needed
...
# Save figure
png_path = 'agraph/res/figures/fir_metrics_comparison.png'
