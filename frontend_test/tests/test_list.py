...
architecture.new_module(name='accumulator',              instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'adderbf16'})
architecture.new_module(name='multiplier',               instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'multiplierbf16'})
architecture.new_module(name='input_register',           instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'register', 'width': [16]})
architecture.new_module(name='weight_register',          instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'register', 'width': [16]})
architecture.new_module(name='partial_sum_register',     instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'register', 'width': [16]})
architecture.new_module(name='accumulator_register',     instance=[[8, 8], [16, 16]], tag=['pe'],  query={'class': 'register', 'width': [16]})
architecture.new_module(name='row_accumulator',          instance=[[8], [16]],        tag=['acc'], query={'class': 'adderbf16'})
architecture.new_module(name='row_accumulator_register', instance=[[8], [16]],        tag=['acc'], query={'class': 'register', 'width': [16, 32]})
