...
design = Design(name='fir_sc_256', yaml_path='agraph_casestudy/fir_sc_256/description/')
...
event.new_event(name='fir', subevent=['mult', 'acc', 'shift_reg', 'pnm', 'b2rc', 'control'], performance='agraph_casestudy/fir_sc_256/performance/performance.py')
