...
csv_path = 'agraph_casestudy/tnn/results/'
...
for config in configs:
    path = f'agraph_casestudy/tnn/description/runs/{config}'
    ...
    array_dim = architecture['syn_readout']['instance']
    ...
    syn_energy = ((dynamic_power_dict[array_dim_str] / 1e3) * runtime['value']) * 1e9

    dynamic_energy['value'] = dynamic_energy['value']
