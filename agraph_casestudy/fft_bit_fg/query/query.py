...
if not os.path.exists('agraph_casestudy/fft_bit_fg/results/'):
    os.makedirs('agraph_casestudy/fft_bit_fg/results/')
...
csv_path = 'agraph_casestudy/fft_bit_fg/results/'
...
for config in configs:
    path = f'agraph_casestudy/fft_bit_fg/description/runs/{config}'
    ...
    array_dim_str = str(architecture['regA']['query']['width'])
