...
fft_cg_path = 'agraph_casestudy/fft_bit_cg/real_results/'
...
width = 252 / 72
height = width / 2.4# Adjusted for 1 row layout
rows = 1
cols = 3
...
ax_main.set_yticks([0, 10, 20, 30, 40])
...
ax_right.set_yticks([0, 20, 40, 60, 80])
...
# Structure: offsets[j][k] = {'pe': (x_offset, y_offset)}
offsets = [
    # Area (j=0)
    [
        {'pe': (0, 6)},    # 4x4
...
ax_main.legend(handles=legend_elements, loc='upper left', ncol=2, fontsize=8, 
...
# Save the figure
plt.savefig('agraph_casestudy/figures/figures/fft_bit_metrics.png', 
           dpi=300, bbox_inches='tight', facecolor='white')
plt.savefig('agraph_casestudy/figures/figures/fft_bit_metrics.pdf', 
           dpi=300, bbox_inches='tight', facecolor='white')