...
if not os.path.exists('agraph_casestudy/fft_fine_grain/results/'):
    os.makedirs('agraph_casestudy/fft_fine_grain/results/')
...
csv_path = 'agraph_casestudy/fft_fine_grain/results/'
...
for config in configs:
    path = f'agraph_casestudy/fft_fine_grain/description/runs/{config}'
