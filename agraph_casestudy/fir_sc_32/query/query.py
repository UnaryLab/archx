...
csv_path = 'agraph_casestudy/fir_sc_32/results/'
...
for config in configs:
    path = f'agraph_casestudy/fir_sc_32/description/runs/{config}'
    ...
    runtime['value'] = runtime['value'] * (10 / 20)
    ...
    if split_power_df is None:
        split_power_df = pd.DataFrame(columns=['arch', 'bitwidth', 'runtime', f'dynamic_power {power["unit"]}', f'leakage_power {power['unit']}', f'baseline dynamic power {power["unit"]}', 
