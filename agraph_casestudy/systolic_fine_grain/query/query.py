...
if not os.path.exists('agraph_casestudy/systolic_fine_grain/results/'):
    os.makedirs('agraph_casestudy/systolic_fine_grain/results/')
...
csv_path = 'agraph_casestudy/systolic_fine_grain/results/'
...
for config in configs:
    path = f'agraph_casestudy/systolic_fine_grain/description/runs/{config}'
    ...
    array_dim = architecture['multiplier']['instance']
    ...
    count = aggregate_event_count(event_graph=event_graph, workload=workload, event='weight_en_reg')
